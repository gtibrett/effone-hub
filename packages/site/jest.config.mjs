 ...
 * default ignores everything under node_modules, but d3-* (pulled by
 * @mui/x-charts) ships ESM-only and needs SWC transformation to be
 * requirable from CJS test code.
 */
...
// `.pnpm/` prefix.
const esmInNodeModules = '/node_modules/(?!(?:\\.pnpm/)?(?:d3-|internmap|delaunator|robust-predicates))';
