...
export default function DriversFilters({filters, setFilters}: ListFiltersProps<DriversListFilters>) {
	...
	return (
        <TableFilter handleSearch={handleSearch}>
            <TextField fullWidth size="small" id="drivers-search-filter" label="Driver" variant="outlined" value={localFilters.search} onChange={setStringFilter<DriversListFilters>(setLocalFilters, 'search')} slotProps={{
                inputLabel: {shrink: true}
            }}/>
            <TextField fullWidth size="small" id="drivers-nationality-filter" label="Nationality" variant="outlined" value={localFilters.nationality} onChange={setStringFilter<DriversListFilters>(setLocalFilters, 'nationality')} slotProps={{
                inputLabel: {shrink: true}
            }}/>
