	...
	<Card>
		...
		<CardContent>
			...
			<Typography variant="body1" className="mb-4">
				...
				Driver&apos;s and Constructor&apos;s championship standings. Lap Times, Pit Stops
				and overtakes for each race.
			</Typography>
			<Typography variant="body1" className="mb-4">
				Some of the data contained within comes from{' '}
				<Link href="https://wikipedia.org" target="_blank">
					Wikipedia
					<OpensInNewWindow />
				</Link>
				. Other data was generated using AI, from{' '}
