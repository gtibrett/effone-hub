...
export type TeamFieldsFragment = { __typename?: 'Team', id: string, name: string, countryId: string, colors?: { __typename?: 'AppTeamColor', id: string, primaryHex?: string | null, secondaryHex?: string | null } | null, bio?: { __typename?: 'AppConstructorBio', id: string, description?: string | null, title?: string | null, extract?: string | null, thumbnailUrl?: string | null } | null } & { ' $fragmentName'?: 'TeamFieldsFragment' };
