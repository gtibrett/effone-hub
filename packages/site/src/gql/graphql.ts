...
export type ConstructorPageStaticQueryQuery = { __typename?: 'Query', teams?: Array<{ __typename?: 'Team', id: string, name: string, countryId: string, country?: { __typename?: 'Country', id: string, alpha2Code: string, name: string } | null, colors?: { __typename?: 'AppTeamColor', teamId: string, primaryHex?: string | null, secondaryHex?: string | null } | null, bio?: { __typename?: 'WikipediaBio', title: string, extract?: string | null, thumbnailUrl?: string | null, sourceUrl: string } | null }> | null };

export type AppSeasonStateQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type AppSeasonStateQueryQuery = { __typename?: 'Query', seasons?: Array<{ __typename?: 'Season', year: number, hasResults?: boolean | null }> | null };
...
export type DriversQueryQuery = { __typename?: 'Query', drivers?: Array<{ __typename?: 'Driver', id: string, firstName: string, lastName: string, abbreviation: string, nationalityCountryId: string, totalRaceStarts: number, totalRaceWins: number, totalPodiums: number, bio?: { __typename?: 'WikipediaBio', thumbnailUrl?: string | null } | null, nationalityCountry?: { __typename?: 'Country', id: string, name: string, alpha2Code: string } | null, seasonDrivers: Array<{ __typename?: 'SeasonDriver', season?: { __typename?: 'Season', year: number } | null }> }> | null };
...
export type ConstructorStandingsQueryQuery = { __typename?: 'Query', season?: { __typename?: 'Season', year: number, seasonTeamStandingsByYear: Array<{ __typename?: 'SeasonTeamStanding', teamId: string, positionNumber?: number | null, points: any, team?: { __typename?: 'Team', id: string, name: string, bio?: { __typename?: 'WikipediaBio', thumbnailUrl?: string | null } | null, colors?: { __typename?: 'AppTeamColor', teamId: string, primaryHex?: string | null, secondaryHex?: string | null } | null } | null }>, racesByYear: Array<{ __typename?: 'Race', year: number, round: number, raceTeamStandings: Array<{ __typename?: 'RaceTeamStanding', raceId: number, teamId: string, engineManufacturerId: string, positionNumber?: number | null, points: any, team?: { __typename?: 'Team', id: string, name: string, colors?: { __typename?: 'AppTeamColor', teamId: string, primaryHex?: string | null } | null } | null }> }> } | null };
...
export const AppSeasonStateQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AppSeasonStateQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"seasons"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"EnumValue","value":"YEAR_DESC"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"year"}},{"kind":"Field","name":{"kind":"Name","value":"hasResults"}}]}}]}}]} as unknown as DocumentNode<AppSeasonStateQueryQuery, AppSeasonStateQueryQueryVariables>;
